...
RUN apt-get update && apt-get install -y ros-eloquent-gazebo-ros-pkgs ros-eloquent-teleop-twist-keyboard ros-eloquent-xacro xterm sudo python3-pip && rm -rf /var/lib/apt/lists/*
